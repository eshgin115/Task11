...
namespace DemoApplication.Areas.Client.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        [HttpGet("index")]
        public async Task<IActionResult> IndexAsync([FromServices] IMultipleFileService multipleFileService)
        {
            var model = new IndexViewModel
            {
                ...
                .Select(b => new BookListItemViewModel(
                    ...
                    b.Price,
                    multipleFileService.GetFileUrl(b.Images.Select(b => new ImageData(b.ImageName)).ToList(), Contracts.File.UploadDirectory.Book)
                    ))
                .ToListAsync(),
            };
